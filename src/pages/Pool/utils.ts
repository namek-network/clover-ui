...
export const findPairItem = (poolItems: PoolPairItemType[], fromT: TokenType | undefined, toT: TokenType | undefined): PoolPairItemType|undefined => {
...
export const selectedPairExists = (poolItems: PoolPairItemType[], fromT: TokenType | undefined, toT: TokenType | undefined): boolean => {
